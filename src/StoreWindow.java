...
public class StoreWindow {
    ...
    public void storeWindow(){
        ...
        VBox vBox = new VBox();
        vBox.setSpacing(5);
        vBox.getChildren().addAll(buttonCreateWare, buttonEditWare, buttonSellWare);
    ...
    public void chooseWareToEdit(){
        ...
        storeWindowObject.setTitle("Odense Airsoft alpha 1.0 - Valg af Vare");
        storeWindowObject.setScene(editWareScene);
    }
    ...
    public void editWare(){
        ...
        editWareScene.getStylesheets().addAll(this.getClass().getResource("style.css").toExternalForm());
        storeWindowObject.setTitle("Odense Airsoft alpha 1.0 - Rediger Vare");
        storeWindowObject.setScene(editWareScene);
    }
    ...
    public void createWare(){
        ...
        storeWindowObject.setTitle("Odense Airsoft alpha 1.0 - Opret Vare");
        storeWindowObject.setScene(createWareScene);
    }
